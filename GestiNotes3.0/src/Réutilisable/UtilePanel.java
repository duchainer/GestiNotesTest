...
public class UtilePanel extends JPanel implements ActionListener{
    ...
    /**
     * Constructeur qui cree un UtilePanel avec les informations fournis en parametres
    ...
    /**
     * Constructeur par default qui cree un UtilePanel, ainsi que les composantes de bases
     */
    public UtilePanel() {
    ...
    /**
     * Methode qui ajoute un JComboBox au simplePanel et au ArrayList tabComboBox
     */
    ...
    /**
     * Methode qui ajoute un JTextfield au simplePanel et au ArrayList champs, precede par un JLabel (sans ToolTip)
     ...
     * @param label Le nom du JLabel qui apparait avant le JTextfield
     * @param tooltipText Le texte qui apparait lorsque l'on survole le JLabel et le JTextField
     */
     ...
     * @param index la position du JTextField dans le tableau
     * @param editable boolean qui determine si le JTextField est editable (True = editable/False = non-editable)
     */
