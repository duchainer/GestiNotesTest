...
public final class Etablissement {
    ...
    static String[] noms = {"Attentia", "Bonniveau", "Curviligni","Erzellman", "Frenchmen", "Karato", "K'amon","Donagan"};
    static String[] prenoms = {"Genghis", "Conan", "Sarmoulu", "Zarah", "Rolphi", "Ash", "ToutTemps", "Maurice"};
